...
{
    public class RefrigerationLog
    {
        private int m_RefrigerationLogId;
        ...
        private int m_RefrigerationDevice;
        private int m_MobileId;
        public RefrigerationLog()
        {
        ...
        public int RefrigerationDevice
        {
            get
            {
                return m_RefrigerationDevice;
            }
            set
            {
                m_RefrigerationDevice = value;
            }
        }

        public int RefrigerationLogId
        {
            get
            {
                return m_RefrigerationLogId;
            }
            set
            {
                m_RefrigerationLogId = value;
            }
        }
