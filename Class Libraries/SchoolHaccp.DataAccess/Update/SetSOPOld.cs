...
{
	public class SetSOPOld : DataAccessBase
	{
		...
		public void Update()
		{
            SetSOPOldByIdDataParameters setParameters = new SetSOPOldByIdDataParameters(this.m_SOP);
	...
	public class SetSOPOldByIdDataParameters
	{
		private SOPOld  m_SOP ;
		object[] m_Parameters;

		public SetSOPOldByIdDataParameters(SOPOld  SOP )
		{
			this.m_SOP  = SOP ;
			Build();
		}
