<%@ Page Language="C#" AutoEventWireup="true"  Title="HACCP Builder | View HACCP Plan" Inherits="ControlPanel_District_ViewHACCPPlanNew" Codebehind="ViewHACCPPlanNew.aspx.cs" %>
...
--%>
      ...
      <%--  </td>
		...
		<td style="background-color:#99ccff; color: #000;">
		  ...
		  <b> INGREDIENTS BY FOOD CATEGORY,CCP&rsquo; AND CP&rsquo; </b>
		</td>
		</tr>
		<tr>
		</tr>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <%#  DataBinder.Eval(Container.DataItem, "KeyWords")%>
                                                ...
                                                <b> INSTRUCTIONS: </b>
                                                  ...
                                                  <tr id="Tr22" runat="server" visible='<%# string.IsNullOrEmpty(Eval("Instructions1").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                  <%# (Eval("Instructions1").ToString() != "" ? "1. " : " ") + DataBinder.Eval(Container.DataItem, "Instructions1")%>
                                                  </td>
                                                  </tr>
                                                   <tr id="Tr23"  runat="server" visible='<%# string.IsNullOrEmpty(Eval("Instructions2").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                  <%# (Eval("Instructions2").ToString() != "" ? "2. " : " ") + DataBinder.Eval(Container.DataItem, "Instructions2")%>
                                                    ...
                                                    <tr id="Tr24"  runat="server" visible='<%# string.IsNullOrEmpty(Eval("Instructions3").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                  <%# (Eval("Instructions3").ToString() != "" ? "3. " : " ") + DataBinder.Eval(Container.DataItem, "Instructions3")%>
                                                  </td>
                                                  </tr>
                                                    <tr id="Tr25"  runat="server" visible='<%# string.IsNullOrEmpty(Eval("Instructions4").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                  <%# (Eval("Instructions3").ToString() != "" ? "4. " : " ") + DataBinder.Eval(Container.DataItem, "Instructions4")%>
                                                  </td>
                                                  </tr>
                                                    <tr id="Tr26"  runat="server" visible='<%# string.IsNullOrEmpty(Eval("Instructions5").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                  <%# (Eval("Instructions5").ToString() != "" ? "5. " : " ") + DataBinder.Eval(Container.DataItem, "Instructions5")%>
                                                  </td>
                                                  </tr>
                                                   <tr id="Tr27"  runat="server" visible='<%# string.IsNullOrEmpty(Eval("Instructions6").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                  <%# (Eval("Instructions6").ToString() != "" ? "6. " : " ") + DataBinder.Eval(Container.DataItem, "Instructions6")%>
                                                  </td>
                                                  </tr>
                                                   <tr id="Tr28"   runat="server" visible='<%# string.IsNullOrEmpty(Eval("Instructions7").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                  <%# (Eval("Instructions7").ToString() != "" ? "7. " : " ") + DataBinder.Eval(Container.DataItem, "Instructions7")%>
                                                  </td>
                                                  </tr>
                                                    <tr id="Tr29"  runat="server" visible='<%# string.IsNullOrEmpty(Eval("Instructions8").ToString()) ? false : true%> '>
                                                  <td class="SOPList">
                                                 <%# (Eval("Instructions9").ToString() != "" ? "8. " : " ") + DataBinder.Eval(Container.DataItem, "Instructions8")%>
                                                  </td>
                                                  </tr>
                                                    <tr id="Tr30"  runat="server" visible='<%# string.IsNullOrEmpty(Eval("Instructions9").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                  <%# (Eval("Instructions9").ToString() != "" ? "9. " : " ") + DataBinder.Eval(Container.DataItem, "Instructions9")%>
                                                  </td>
                                                  </tr>
                                                    <tr id="Tr31"  runat="server"  visible='<%# string.IsNullOrEmpty(Eval("Instructions10").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                  <%# (Eval("Instructions10").ToString() != "" ? "10. " : " ") + DataBinder.Eval(Container.DataItem, "Instructions10")%>
                                                  </td>
                                                  </tr>
                                                    <tr id="Tr32"  runat="server" visible='<%# string.IsNullOrEmpty(Eval("Instructions11").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                  ...
                                                  <%# (Eval("Instructions12").ToString() != "" ? "12. " : " ") + DataBinder.Eval(Container.DataItem, "Instructions12")%>
                                                     ...
                                                     <tr id="Tr33"  runat="server" visible='<%# string.IsNullOrEmpty(Eval("Instructions13").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                  <%# (Eval("Instructions13").ToString() != "" ? "13. " : " ") + DataBinder.Eval(Container.DataItem, "Instructions13")%>
                                                  </td>
                                                  </tr>
                                                     <tr id="Tr34"  runat="server" visible='<%# string.IsNullOrEmpty(Eval("Instructions14").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                  <%# (Eval("Instructions14").ToString() != "" ? "14. " : " ") + DataBinder.Eval(Container.DataItem, "Instructions14")%>
                                                  </td>
                                                  </tr>
                                                    <tr id="Tr35"  runat="server" visible='<%# string.IsNullOrEmpty(Eval("Instructions15").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                  ...
                                                  <%# (Eval("Instructions16").ToString() != "" ? "16. " : " ") + DataBinder.Eval(Container.DataItem, "Instructions16")%>
                                                   ...
                                                   <tr id="Tr36"  runat="server" visible='<%# string.IsNullOrEmpty(Eval("Instructions17").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                  <%# (Eval("Instructions17").ToString() != "" ? "17. " : " ") + DataBinder.Eval(Container.DataItem, "Instructions17")%>
                                                  </td>
                                                  </tr>
                                                   <tr id="Tr37"  runat="server" visible='<%# string.IsNullOrEmpty(Eval("Instructions18").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                  <%# (Eval("Instructions18").ToString() != "" ? "18. " : " ") + DataBinder.Eval(Container.DataItem, "Instructions18")%>
                                                  </td>
                                                  </tr>
                                                     <tr id="Tr38"  runat="server" visible='<%# string.IsNullOrEmpty(Eval("Instructions19").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                  <%# (Eval("Instructions19").ToString() != "" ? "19. " : " ") + DataBinder.Eval(Container.DataItem, "Instructions19")%>
                                                  </td>
                                                  </tr>
                                                   <tr id="Tr39"  runat="server" visible='<%# string.IsNullOrEmpty(Eval("Instructions20").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                 ...
                                                 <b> MONITORING:</b>
                                                    ...
                                                    <tr id="Tr40"  runat="server" visible='<%# string.IsNullOrEmpty(Eval("Monitoring1").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                  <%# (Eval("Monitoring1").ToString() != "" ? "1. " : " ") + DataBinder.Eval(Container.DataItem, "Monitoring1")%>
                                                  </td>
                                                  </tr>
                                                   <tr id="Tr41"  runat="server" visible='<%# string.IsNullOrEmpty(Eval("Monitoring2").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                  <%# (Eval("Monitoring2").ToString() != "" ? "2. " : " ") + DataBinder.Eval(Container.DataItem, "Monitoring2")%>
                                                  </td>
                                                  </tr>
                                                    <tr id="Tr42"  runat="server" visible='<%# string.IsNullOrEmpty(Eval("Monitoring3").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                  <%# (Eval("Monitoring3").ToString() != "" ? "3. " : " ") + DataBinder.Eval(Container.DataItem, "Monitoring3")%>
                                                  </td>
                                                  </tr>
                                                    <tr id="Tr43"  runat="server" visible='<%# string.IsNullOrEmpty(Eval("Monitoring4").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                  <%# (Eval("Monitoring4").ToString() != "" ? "4. " : " ") + DataBinder.Eval(Container.DataItem, "Monitoring4")%>
                                                  </td>
                                                  </tr>
                                                   <tr id="Tr44"  runat="server" visible='<%# string.IsNullOrEmpty(Eval("Monitoring5").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                  <%# (Eval("Monitoring5").ToString() != "" ? "5. " : " ") + DataBinder.Eval(Container.DataItem, "Monitoring5")%>
                                                  </td>
                                                  </tr>
                                                      <tr id="Tr45"  runat="server" visible='<%# string.IsNullOrEmpty(Eval("Monitoring6").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                  <%# (Eval("Monitoring6").ToString() != "" ? "6. " : " ") + DataBinder.Eval(Container.DataItem, "Monitoring6")%>
                                                  </td>
                                                  </tr>
                                                  <tr id="Tr46"  runat="server" visible='<%# string.IsNullOrEmpty(Eval("Monitoring7").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                 ...
                                                 <b> CORRECTIVE ACTIONS:</b>
                                                    ...
                                                    <tr id="Tr47"  runat="server" visible='<%# string.IsNullOrEmpty(Eval("CorrectiveAction1").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                  <%# (Eval("CorrectiveAction1").ToString() != "" ? "1. " : " ") + DataBinder.Eval(Container.DataItem, "CorrectiveAction1")%>
                                                  </td>
                                                  </tr>
                                                   <tr id="Tr48"  runat="server" visible='<%# string.IsNullOrEmpty(Eval("CorrectiveAction2").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                  <%# (Eval("CorrectiveAction2").ToString() != "" ? "2. " : " ") + DataBinder.Eval(Container.DataItem, "CorrectiveAction2")%>
                                                  </td>
                                                  </tr>
                                                    <tr id="Tr49"  runat="server" visible='<%# string.IsNullOrEmpty(Eval("CorrectiveAction3").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
                                                  ...
                                                  <%# (Eval("CorrectiveAction4").ToString() != "" ? "4. " : " ") + DataBinder.Eval(Container.DataItem, "CorrectiveAction4")%>
                                                   ...
                                                   <tr id="Tr50"  runat="server" visible='<%# string.IsNullOrEmpty(Eval("CorrectiveAction5").ToString()) ? false : true%>'>
                                                  <td class="SOPList">
...
<br />•	Hold hot foods at 135 &#176;F or above 
<br />•	Hold cold foods at 41 &#176;F or below
<br /><br />
<br />
...
<br />•	Verify that the air/water temperature of any unit is at 135 &#176;F or above before use.
<br />•	Reheat foods in accordance with the Reheating for Hot Holding SOP.
<br />•	All hot potentially hazardous foods should be 135 &#176;F or above before placing the food out for display or service.  
...
<br />•	Verify that the air/water temperature of any unit is at 41 &#176;F or below before use.
<br />•	Chill foods, if applicable, in accordance with the Cooling Potentially Hazardous Foods SOP.

<br />•	All cold potentially hazardous foods should be 41 &#176;F or below before placing the food out for display or service.  
...
<br />•	Chill food in accordance with the Cooling Potentially Hazardous Foods SOP if the food is not 41 &#176;F or below.
<br />•	Verify that the air temperature of any cold holding unit is at 41 &#176;F or below before use and at least every 4 hours thereafter during all hours of operation.   
<br /><br />
<br />
...
2. For hot foods: 
<br />•	Reheat the food to 165 &#176;F for 15 seconds if the temperature is found to be below 135 &#176;F and the last temperature measurement was 135 &#176;F or higher and taken within the last 2 hours.  Repair or reset holding equipment before returning the food to the unit, if applicable.
<br />•	Discard the food if it cannot be determined how long the food temperature was below 135 &#176;F.<br />
<br />

3. For cold foods: 
<br />•	Rapidly chill the food using an appropriate cooling method if the temperature is found to be above 41 &#176;F and the last temperature measurement was 41 &#176;F or below and taken within the last 2 hours:  
...
5. Discard the food if it cannot be determined how long the food temperature was above 41 &#176;F. <br />
<br />
...
4. Discard the food if it cannot be determined how long the food temperature was above 41 &#176;F or below 135 &#176;F.<br />
<br />
...
<br />a.	For fresh meat, fish, and poultry products, insert a clean and sanitized thermometer into the center of the product to ensure a temperature of 41 &#176;F or below.  The temperature of milk should be 45 &#176;F or below. 
<br />b.	For packaged products, insert a food thermometer between two packages being careful not to puncture the wrapper.  If the temperature exceeds 41 &#176;F, it may be necessary to take the internal temperature before accepting the product.
<br />c.	For eggs, the interior temperature of the truck should be 45 &#176;F or below.  
<br /><br />
<br />
...
3. If State or local requirements are based on the 2009 FDA Food Code, heat processed, ready-to-eat foods from a package or can, such as canned green beans or prepackaged breakfast burritos, to an internal temperature of at least 135 &#176;F for 15 seconds for hot holding.  <br />
<br />
...
<br />•	Heat processed, ready-to-eat foods from a package or can to at least 135 &#176;F for 15 seconds
<br />•	Heat leftovers to 165 &#176;F for 15 seconds
<br />•	Rotate (or stir) and cover foods while heating 
<br />•	Allow to sit for 2 minutes after heating 
<br /><br />
<br />

6. Reheat all foods rapidly.  The total time the temperature of the food is between 41 &#176;F and 165 &#176;F may not exceed 2 hours. <br />
...
13. Use only hand sanitizers that comply with the 2009 FDA Food Code.  Confirm with the manufacturer that the hand sanitizers used meet the requirements of the 2009 FDA Food Code.<br />
<br />
...
<br />•	Maintain the temperature of refrigerated, potentially hazardous foods at 41 &#176;F or below and cooked foods that are transported hot at 135 &#176;F or above.
<br /><br />
<br />
...
<br />41 &#176;F and hot food temperatures at 135 &#176;F or above.
...
3. Reheat food to 165 &#176;F for 15 seconds if the internal temperature of hot food is less than 135 &#176;F.  Refer to the Reheating Potentially Hazardous Foods SOP.<br />
<br />

4. Cool food to 41 &#176;F or below using a proper cooling procedure if the internal temperature of cold food is greater than 41 &#176;F.  Refer to the Cooling Potentially Hazardous Foods SOP for the proper procedures to follow when cooling food.<br />
<br />
...
<br />•	Temperature measurement should be 32 &#176;F (+ 2 &#176;F) [or 0 &#176;C (+ 1 &#176;C)].  If not, adjust according to manufacturer’s instructions.
<br /><br />
<br />
...
<br />•	Allow the temperature reading to stabilize before reading temperature.
<br />•	Reading should be 212 &#176;F (+ 2 &#176;F) [or 100 &#176;C (+ 1 &#176;C)].  This reading may vary at higher altitudes.  If adjustment is required, follow manufacturer’s instructions.
<br /><br />
<br />
...
7. Wash fresh produce vigorously under cold running water or by using chemicals that comply with the 2009 FDA Food Code.  Packaged fruits and vegetables labeled as being previously washed and ready-to-eat are not required to be washed.  <br />
<br />
...
<br />•	Wet hands and forearms with warm, running water at least 100 &#176;F and apply soap.
...
<br />•	Use only hand sanitizers that comply with the 2009 FDA Food Code.  Confirm with the manufacturers that the hand sanitizers used meet these requirements. 
                ...
                <SelectParameters>
                    <asp:SessionParameter Name="nKitchenId" SessionField="KitchenId" Type="Int32" />
                     ...
                     <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:HaccpConnectionString %>" 
                        SelectCommand="uspAdm_GetFoodCategoryCorrectiveAction" SelectCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:SessionParameter Name="nKitchenId" SessionField="KitchenId" Type="Int32" />
                </SelectParameters>
                    </asp:SqlDataSource> --%>
