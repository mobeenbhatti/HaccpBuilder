<%@ Page Language="C#" MasterPageFile="~/ControlPanel/DistrictMaster.master" AutoEventWireup="true"  Inherits="ControlPanel_District_KitchenValidation" Title="HACCP Builder | Kitchen Groups" Codebehind="KitchenValidation.aspx.cs" %>
            ...
            onrowdatabound="grdhKitchenGroup_RowDataBound" AllowPaging="True">                
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Kitchen Name">
	                    ...
	                    <asp:TemplateField HeaderText="Validation Group">
	                        <ItemTemplate>
	                            <asp:DropDownList ID="ddlCheckListGroup" runat="server" DataSourceID="ObjectDataSource1"
	                             DataTextField="GroupName" DataValueField="ValidationGroupId" CssClass="DropDown"></asp:DropDownList>
	                    ...
	                    <asp:TemplateField HeaderText="Questions">
	                        <ItemTemplate>
	                            <asp:HyperLink ID="hlQuestion" runat="server" NavigateUrl='<%#"~/ControlPanel/District/ValidationCustomQuestion.aspx?GroupId=" + DataBinder.Eval(Container.DataItem, "CheckListGroupId")%>' 
	                             Text="View">
	                            </asp:HyperLink>
	                        </ItemTemplate>
