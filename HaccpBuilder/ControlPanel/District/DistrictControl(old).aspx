<%@ Page Language="C#" MasterPageFile="~/ControlPanel/MasterPage2.master" AutoEventWireup="true" Inherits="ControlPanel_District_Default" Title="Untitled Page" Codebehind="DistrictControl(old).aspx.cs" %>
        ...
        <div class="ContentLeft" >
                ...
                <div class="Buttons">
                   ...
                   <div class="ButtonsCols">
                    <asp:ImageButton ID="btnCreateSOPGroup" runat="server"  ImageUrl="~/images/District Images/ButtonCreateSOPGroup.jpg" /> 
                   </div>                   
                   ...
                   <div class="FloatLeft">
                    ...
                    <div style="margin-left:115px; float:left;"></div>
                   <div class="ButtonsCols">
