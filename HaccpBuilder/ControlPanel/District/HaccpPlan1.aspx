<%@ Page Language="C#" AutoEventWireup="true" Inherits="ControlPanel_District_HaccpPlan1" Codebehind="HaccpPlan1.aspx.cs" %>
...
<body style="margin:0px; background:#999999;">
    <form id="form1" runat="server">   
     <div class="haccpInner">
		    ...
		    <td class="haccpText" align="center" >	
		        ...
		        <ItemTemplate>
		            <table  > 
                      ...
                      <tr>
                            <td class="haccpText" align="left">
                                <asp:Label ID="Label1" Text='<%# "County: " + DataBinder.Eval(Container.DataItem,"State") %>' runat="server"></asp:Label>
                            </td>  
                        </tr>
                         <tr>
                        </tr>
		...
		<tr>
		    <td class="haccpText">
		       <p><b> Do any Outputs contain potential allergen input</b></p>
		...
		<tr>
		    <td class="haccpText">
		       <b> If yes, describe allergen input</b>
		    </td>
