<%@ Page Language="C#" MasterPageFile="CorporateMaster.master"  AutoEventWireup="true" Inherits="ControlPanel_District_CreateKitchen" Title="HACCP Builder | Edit Location" Codebehind="CreateKitchen.aspx.cs" %>
...
<div class="container">   
           ...
           <h2>{ INSTRUCTIONS }</h2>
             ...
             <h1>Once you click submit, an email will be sent to the email address
               ...
               <h1><b>SPECIAL NOTE:</b> If you have groups of locations that are similar
                    we recommend you build master locations and then copy.<br />
                    <b>EDIT AN EXISTING LOCATION:</b>  Please go back to the Control Panel and find the location 
    ...
    <h2><b>MASTER LOCATIONS:</b>  Please refer to user's guide to understand the value of creating a master location.  Creating a master location can save your Corporation an incredible amount of time.</h2>
  ...
  <div class="form4 left">
    ...
    <div class="input left">
     ...
     <div class="clear"></div>
    <h1 class="left h2margin-r">Logo Image:</h1>
    <div class="input left">
  ...
  <div class="form3">
    <div class="right button-margin">
        ...
        <asp:Button ID="cmdEdit" runat="server" Visible="false" Text="Edit" CssClass="Button" onclick="cmdEdit_Click" />
        <asp:Button id="cmdCancel" runat="server" Visible="false" CssClass="Button" Text="Cancel" onclick="cmdCancel_Click" />        
    </div>
    <div class="clear"></div>
  </div>  
  </ContentTemplate>
  <Triggers>
    ...
    <asp:PostBackTrigger ControlID="cmdEdit" />
  </Triggers>
     </asp:UpdatePanel>
   ...
   <div class="table">
    <div class="box-header">
      <h4 class="left">List of Cold Holding Log Entries</h4>
        ...
        <table  border="0" cellspacing="0" cellpadding="0" width="700" class="zebra"> 
                <!-- Logs -->
                <tr>
                <td colspan="3">
                ...
                <tr runat="server" id="pnlCleaninLog">
                ...
                <tr runat="server" id="pnlColdHoldingLog">
             ...
             Display="None" Type="Double" Operator="GreaterThanEqual" ErrorMessage="The Value in field Cold Holding High Temp field should be Greater than or equal to Low Temp field"></asp:CompareValidator></td>--%>
                ...
                <tr runat="server" id="pnlFreezerLog">
                ...
                NavigateUrl="~/ControlPanel/District/FreezerLogCustom.aspx?LogType=2" Text="Click Here To View/Edit HACCP and Corrective Actions"></asp:HyperLink>
                 ...
                 <tr runat="server" id="pnlFreezerNewLog">
                ...
                <tr runat="server" id="pnlTemperatureLog">
                ...
                <tr runat="server" id="pnlHotHoldingLog">
               ...
               <%-- <td align="center"><asp:TextBox ID="txtHotHoldingLogLow" runat="server" CssClass="TextTemperature"></asp:TextBox>
                ...
                <tr runat="server" id="pnlMaintenanceLog">
                ...
                <tr runat="server" id="pnlReceivingLog">
             ...
             Display="None" Type="Double" Operator="GreaterThanEqual" ErrorMessage="The Value in field Receiving Log High Temp field should be Greater than or equal to Low Temp field"></asp:CompareValidator></td>--%>
                ...
                <tr runat="server" id="pnlRefrigerationLog">
             ...
             Display="None" Type="Double" Operator="GreaterThanEqual" ErrorMessage="The Value in field Refrigeration Log High Temp field should be Greater than or equal to Low Temp field"></asp:CompareValidator></td>--%>
                ...
                <tr runat="server" id="pnlShippingLog">
                ...
                <tr runat="server" id="pnlThermoLog">
              ...
              <%--  <asp:HyperLink ID="hlThermometerLog"  runat="server" 
                ...
                <tr runat="server" id="pnlChecklist">
                ...
                <tr runat="server" id="pnlValidation">
