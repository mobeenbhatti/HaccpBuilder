...
public partial class ControlPanel_District_FreezerLogCustom : System.Web.UI.Page
{
    ...
    private void UpdateCriticalLimits()
    {
       ...
       // criticalLimit.CCLTempHigh = (txtCclHigh.Text.Equals(string.Empty)) ? 999 : float.Parse(txtCclHigh.Text);
        ...
        {
            criticalLimit.CCLTempHigh1 = 999;
            ...
            criticalLimit.QCLTempHigh1 = 999;
            ...
            criticalLimit.SCLTempHigh1 = 999;
            ...
            criticalLimit.CCLTempHigh2 = 999;
            ...
            criticalLimit.QCLTempHigh2 = 999;
            ...
            criticalLimit.SCLTempHigh2 = 999;
