<%@ Page Language="C#" AutoEventWireup="true" Theme="Default" Inherits="ControlPanel_PrintChecklist" Codebehind="MealServingByDate2.aspx.cs" %>
...
<body>
    ...
    <div class="ContentRight">
        ...
        <asp:ImageButton ID="btnContinue" runat="server"  
                ImageUrl="~/images/buttons/ButtonSaveAndContinue.jpg" style="height: 20px" 
                onclick="btnContinue_Click" />
        <asp:ImageButton ID="btnBack" runat="server"  
                ImageUrl="~/images/buttons/ButtonNoSelect.jpg" style="height: 20px" onclick="btnBack_Click" 
                />
        </div>   
    </div>    
     <div class="ViewPlanClearer"></div>
