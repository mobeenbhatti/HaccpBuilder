<%@ Page Title="" Language="C#" MasterPageFile="~/ControlPanel/Kitchen/MasterPage2.master" AutoEventWireup="true" Inherits="ControlPanel_Kitchen_ProceduralQuestion" Codebehind="ProceduralQuestion.aspx.cs" %>
...
<div class="bdy_contents">
    ...
    <div class="grey_bg_dis">
        <div class="ProceduralDiv">
            <div class="ProceduralLabel">Do any outputs/menu items contain potential allergen Inputs:</div>
            ...
            <asp:RadioButton ID="rdbNA" Text="NA" GroupName="Answer" onClick="SetValidator(1,0)" runat="server" />
    ...
    <asp:View ID="panel3" runat="server">
        ...
        <div class="grey_bg_dis">
            <div id="Div1">
                 <div class="ProceduralLabel">Describe basic procedures to eliminate outputs/menu items from contamination by biological, chemical and physical food safety hazards</div>
    ...
    <div class="grey_bg_dis">
        <div class="ProceduralDiv">
            ...
            <asp:RadioButton ID="rdbNA4" Text="NA" GroupName="Answer" onClick="SetValidator(4,0)" runat="server" />       
            <div class="Clearer"></div>        
        </div>
        <div class="ProceduralDiv">
