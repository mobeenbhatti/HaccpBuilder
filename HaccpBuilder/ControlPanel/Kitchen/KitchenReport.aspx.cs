...
public partial class ControlPanel_Kitchen_KitchenReport : System.Web.UI.Page
{
    ...
    {        
        ...
        //Response.AddHeader("content-disposition", "attachment; filename=" + ReportName + "_" + cldStartDate.SelectedDate.ToShortDateString() + "_" + cldEndDate.SelectedDate.ToShortDateString() + "_" + DateTime.Now.Millisecond.ToString() + ".xls");
        string strReportName = ReportName + "_" + cldStartDate.SelectedDate.ToShortDateString() + "_" + cldEndDate.SelectedDate.ToShortDateString() + "_" + DateTime.Now.Millisecond.ToString() + ".xls";
