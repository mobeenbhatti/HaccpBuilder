...
public partial class ControlPanel_Kitchen_MenuItems : System.Web.UI.Page
{
...

    {
        ...
        if (Request.QueryString["Id"] != null)
        {
            ...
            DataSet dsIngredients = getIngredients.GetIngredientsByKitchenMenuItemId((int)Session["KitchenId"]);
    ...
    private void InsertData()
    {
       ...
       // menuItem.ProcessId = rdlProcess.SelectedIndex;
        ...
        menuItem.RecipeNumber = txtRecipe.Text;
        menuItem.Selected = 1;
    ...
    private void SubmitData()
    {
        ...
        else
        {
            ...
            {
                menuItem.MenuItemId = (int)Session["IngredientId"];
            }
        }
        menuItem.Instructions = txtRecipe.Text;
        menuItem.KitchenId = (int)Session["KitchenId"];
