<%@ Page Title="HACCP Builder | Refrigeration Log" Language="C#" MasterPageFile="~/ControlPanel/Kitchen/Facility.Master" AutoEventWireup="true" CodeBehind="RefrigerationLog.aspx.cs" Inherits="HaccpBuilder.ControlPanel.Kitchen.RefrigerationLogNew" %>
...
<div class="container"><!----CONTAINER-START----->
  ...
  <div class="form3">
    <div class="left">      
      <div class="input">
        <asp:DropDownList ID="ddlRefrigerationDevice"  DataSourceID="odsRefrigerationDevice" data-editableCombobox="true"  DataTextField="Name" DataValueField="Id" AppendDataBoundItems="false" runat="server">
            <asp:ListItem>Select Refrigeration Device</asp:ListItem>
        </asp:DropDownList>
        <asp:RequiredFieldValidator ID="rfvIngredient" runat="server" Display="None" ErrorMessage="Please Select Refrigeration Device" ControlToValidate="ddlRefrigerationDevice"  Font-Names="Verdana"
  ...
  <div class="form4 left marginright">
    ...
    <div class="input left">
        <asp:TextBox ID="txtTemperature" runat="server" MaxLength="8" ></asp:TextBox>
  ...
  <div class="table">
    <div class="box-header">
      <h4 class="left">List of Refrigeration Log Entries</h4>
    </div>
