...
public partial class ControlPanel_Kitchen_FoodSafetyChecklisReview : System.Web.UI.Page
{
    ...
    protected void grdQuestion_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            // MBS-(03-19-10)
            // BUG ID - 1877
            hlCategory.NavigateUrl = "~/ControlPanel/Kitchen/FoodSafetyChecklist.aspx?week=" + DataBinder.Eval(e.Row.DataItem, "ResponseWeek") + "&Section=" + DataBinder.Eval(e.Row.DataItem, "SectionId") + "&Date=" + ViewState["EntryDate"].ToString();
