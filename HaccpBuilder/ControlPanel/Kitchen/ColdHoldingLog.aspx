<%@ Page Language="C#" MasterPageFile="~/ControlPanel/Kitchen/Facility.Master" AutoEventWireup="true" Title="HACCP Builder | Cold Holding Log" CodeBehind="ColdHoldingLog.aspx.cs" Inherits="HaccpBuilder.ControlPanel.Kitchen.ColdHoldingLogTest" %>
...
<div class="container"><!----CONTAINER-START----->
    ...
    <div class="left">
      ...
      <div class="input">
        ...
        <div class="left margin-lr">
          ...
          <div class="input">
            <asp:DropDownList ID="ddlMenuItem" DataSourceID="odsMenuItem" Enabled="false" DataTextField="Name" DataValueField="MenuItemId"  runat="server" data-editableCombobox="true"
  ...
  <div class="form4 left marginright">
    ...
    <div class="input left">
        <asp:TextBox ID="txtTemp1" runat="server" MaxLength="8" ></asp:TextBox>
  ...
  <div class="form4 left">
    ...
    <div class="input left">
        <asp:TextBox ID="txtTemp2" runat="server" MaxLength="8" ></asp:TextBox>
