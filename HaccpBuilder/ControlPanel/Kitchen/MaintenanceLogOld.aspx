<%@ Page Language="C#" MasterPageFile="~/ControlPanel/Kitchen/MasterPage2.master" AutoEventWireup="true" Inherits="ControlPanel_MaintenanceLog" Title="HACCP Builder | Maintenance Log" Codebehind="MaintenanceLogOld.aspx.cs" %>
    ...
    <div class="bdy_contents">
        <div class="grey_bg_dis">
            <div class="red_heading">
                { Maintenance Log }</div>
            <div class="discp_txt">
                Directions: Record item name, time, the Maintenance levels, and any corrective action taken on this form. 
        ...
        <div class="log_heading">
            <div class="red_heading">
                { List of Maintenance Log Entries }</div>
        </div>
                        ...
                        <table width="368" border="0" cellspacing="0" cellpadding="0">
                            <tr align="right">
                                <td colspan="3" align="left" class="red_heading">
                                    ...
                                    Add/Edit Maintenance control Log }
                                </td>
                            </tr>
                            <tr>
