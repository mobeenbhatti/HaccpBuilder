<%@ Page Language="C#" MasterPageFile="~/ControlPanel/Kitchen/MasterPage2.master" AutoEventWireup="true" Inherits="ControlPanel_HotHoldingLog" Title="HACCP Builder | Hot Holding Time & Temperature Log" Codebehind="HotHoldingLogOld.aspx.cs" %>
    ...
    <div class="bdy_contents">
        <div class="grey_bg_dis">
            <div class="red_heading">
                { Hot Holding Time & Temperature Log }</div>
            <div class="discp_txt">
        ...
        <div class="log_heading">
            <div class="red_heading">
                { List of Hot Holding Log Entries }</div>
        </div>
