<%@ Page Language="C#" MasterPageFile="~/ControlPanel/Kitchen/MasterPage2.master" AutoEventWireup="true" Inherits="ControlPanel_Kitchen_KitchenReport" Title="HACCP Builder | Kitchen Reports" Codebehind="KitchenReport.aspx.cs" EnableEventValidation="false" %>
...
<div class="bdy_contents">
                      ...
                      <td><table width="690" border="0" cellspacing="0" background="../../images/District Images/table_bg.gif">
                        <tr>
                          <td height="165" valign="top"><table width="690" border="0" cellspacing="5">
                            <tr>
                              <td class="red_heading">{ KITCHEN REPORTS }</td>
                            </tr>
                            <tr>
	...
	<table  border="0" cellspacing="0" cellpadding="0">                                 
                <tr>
                 ...
                 <td colspan="2" ><img src="../../images/District Images/spacer.gif" width="10" height="25" /></td>                 
                </tr>
                <tr>    
                  <td >Start Date:</td>
                  <td><img src="../../images/District Images/spacer.gif" width="10" height="25" /></td>
                  <td> <ew:CalendarPopup ID="cldStartDate" runat="server" CommandName="Calendar" ControlDisplay="TextBoxImage" 
                ...
                <tr>   
                  <td >End Date:</td>
                  <td><img src="../../images/District Images/spacer.gif" width="10" height="25" /></td>
                  <td><ew:CalendarPopup ID="cldEndDate" runat="server" CommandName="Calendar" ControlDisplay="TextBoxImage" 
                      ImageUrl="~/images/Calendar_scheduleHS.png" /> 
                 <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="cldStartDate" ControlToValidate="cldEndDate" 
                     ErrorMessage="Please select valid date" Operator="GreaterThanEqual" Type="Date"></asp:CompareValidator>
                  </td>
                  <td ><img src="../../images/District Images/spacer.gif" width="10" height="25" /></td> 
                ...
                <tr>
                   <td colspan="5" class="red_heading"> <asp:Label ID="lblMessage" runat="server" Text="No Record Found" Visible="false"></asp:Label></td>                  
                </tr>
                <tr>
                   <td colspan="5">&nbsp;</td>                  
                </tr>               
