...
public partial class ControlPanel_Kitchen_ValidationDates : System.Web.UI.Page
{
    ...
    protected void rptAlertDates_OnItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("~/ControlPanel/Kitchen/ValidationChecklist.aspx?date=" + btnDate.Text);
        }
