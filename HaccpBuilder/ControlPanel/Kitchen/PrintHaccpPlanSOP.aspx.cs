...
public partial class ControlPanel_Kitchen_PrintTest : System.Web.UI.Page
{
    ...
    protected void rptProcess_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            grdMenu.DataSource = getMenuItem.GetMenuItemsNewByProcess((int)Session["KitchenId"], int.Parse(hfProcessId.Value));
            grdMenu.DataBind();
