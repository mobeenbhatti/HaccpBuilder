<%@ Page Language="C#" MasterPageFile="~/ControlPanel/Kitchen/MasterPage2.master" AutoEventWireup="true"  Inherits="ControlPanel_Kitchen_ViewHACCPBuilderPlan" Title="HACCP Builder | View HACCP Plan" Codebehind="ViewHACCPBuilderPlan.aspx.cs" %>
...
<div style="overflow:visible; height:50%;">
    ...
    <SelectParameters>
        ...
        <tr>
			<td>						
				<h2 style="color: #000; background-color:#99ccff">HACCP PROCEDURAL QUESTIONS AND ANSWERS</h2>									
			</td>		
		</tr>
		<%-- Buyes Specs --%>
		<tr>
		...
		<tr>
		    <td>
		        <div id="lblQuestion1" runat="server"></div>
		       <%-- <asp:Label ID="lblQuestion1" Text="" runat="server" BackColor="Beige"></asp:Label>--%>
		    </td>
		</tr>
		<%-- Allergen Management --%>
		<tr>
		...
		<tr>
		    <td>
		       <p><h4> Do any menu items contain potential allergen ingredients</h4></p>
		...
		<tr>
		    <td>
		        <div id="lblQuestion2" runat="server"></div>
		...
		<tr>
		    <td>
		        <div id="lblQuestion2b" runat="server"></div>
		...
		<tr>
		    <td>
		      <h4> Describe basic procedures to eliminate menu items from contamimation by biological, chemical and physical food safety hazards</h4>
		    </td>
		</tr>
		<tr>
		    <td>
		        <div id="lblQuestion3" runat="server"></div>
		...
		<tr>
		    <td>
		        <div id="lblQuestion4" runat="server"></div>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Answer" ItemStyle-Width="80px">
                        <ItemTemplate >
                            ...
                            <asp:RadioButton ID="rdbAnswerNA" Text="No" GroupName="Answer"  runat="server" /> 
 ...
 <FooterTemplate>
        ...
        <tr>
			<td>
						<h2 style="color: #000; padding-top: 30px; background-color:#99ccff;">Categorizing Menu Items and Identification of 
	    ...
	    <%-- Menu Items Repeater --%>
	    <tr>
	    <td ><h2 style=" background-color:#c0c0c0;">Menu Detail All Recipes </h2>            
 ...
 <FooterTemplate>
                ...
                <Columns> 
                    ...
                    <%--<asp:TemplateField HeaderText="Entry ID">                        
	                    ...
	                    <asp:TemplateField HeaderText="Hazards">
	                        <ItemTemplate>
	                             <asp:Label ID="lblHazard" runat="server"  Text='<%# DataBinder.Eval(Container.DataItem, "Hazard")  %>'></asp:Label>	                           
	                        </ItemTemplate>
        ...
        <tr>
		    <td >
						...
						<p>
							* From the 2005 FDA Food Code (as amended 08-29-03 in the Supplement to the 2001
							Food Code)</p>
		...
		<tr>
			<td>						
				...
				<asp:GridView ID="grdMenuProcess1" runat="server" SkinID="gridviewHeadSkin" AutoGenerateColumns="False" 
                    DataSourceID="ObjectDataSource6" onrowdatabound="grdMenuProcess1_RowDataBound">                
                <Columns> 
                    <%--<asp:BoundField DataField="Id" HeaderText="Entry ID" ItemStyle-Width="50px" HeaderStyle-CssClass="gridheaderline" />--%>
		...
		<tr>
			<td>						
				...
				<asp:GridView ID="grdMenuProcess2" runat="server" SkinID="gridviewHeadSkin" AutoGenerateColumns="False" 
                    DataSourceID="ObjectDataSource7" onrowdatabound="grdMenuProcess2_RowDataBound">                
                <Columns> 
                    <%--<asp:BoundField DataField="Id" HeaderText="Entry ID" ItemStyle-Width="50px" HeaderStyle-CssClass="gridheaderline" />--%>
		...
		<tr>
			<td>						
				...
				<asp:GridView ID="grdMenuProcess3" runat="server" SkinID="gridviewHeadSkin" AutoGenerateColumns="False" 
                    DataSourceID="ObjectDataSource8" onrowdatabound="grdMenuProcess3_RowDataBound">                
                <Columns> 
                    <%--<asp:BoundField DataField="Id" HeaderText="Entry ID" ItemStyle-Width="50px" HeaderStyle-CssClass="gridheaderline" />--%>
		...
		<tr>
			<td>						
				...
				<asp:GridView ID="grdMenuProcess4" runat="server" SkinID="gridviewHeadSkin" AutoGenerateColumns="False" 
                    DataSourceID="ObjectDataSource9" onrowdatabound="grdMenuProcess4_RowDataBound" >                
                <Columns> 
                    <%--<asp:BoundField DataField="Id" HeaderText="Entry ID" ItemStyle-Width="50px" HeaderStyle-CssClass="gridheaderline" />--%>
		...
		<tr>
		<td style="background-color:#99ccff; color: #000;">
		   <h1> FOOD CATEGORIES AND ASSOCIATED HAZARDS </h1>
		</td>
		</tr>
		<tr>
		<td>
		     <asp:GridView ID="grdHazards" runat="server" SkinID="gridviewHeadSkin" AutoGenerateColumns="False" 
                ...
                <Columns>                                       
	                    <asp:TemplateField HeaderText="Raw Animal" >
	                        <ItemTemplate>
	                            <asp:Label ID="lblName" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "FoodCategory")  %>'></asp:Label>	                            	                           
	                        </ItemTemplate>
	                    <ItemStyle Width="150px" />
	                    <HeaderStyle CssClass="gridheaderline" />	                        
	                    </asp:TemplateField >	                    
	                    <asp:TemplateField HeaderText="Associated Hazards" >
	                        <ItemTemplate>
	                            <asp:Label ID="lblIngredient" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Hazard") %>'></asp:Label>	                           
	                        </ItemTemplate>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource10" runat="server" 
                OldValuesParameterFormatString="original_{0}" SelectMethod="GetAllHazards" 
                TypeName="SchoolHaccp.BusinessLogic.ProcessGetHazard">                
              </asp:ObjectDataSource>
		</td>
		</tr>
		<%-- SOP's --%>
...
&nbsp;</td>--%>
        ...
        <tr>
            <td align="center">
                <h1> HACCP Plan Built by HACCP BUILDER</h1>
            </td>
        </tr>
        <tr>
            <td align="center">
                ...
                Creators of HBez, HBflex, HBez with Reporting, HBflex with Reporting and Command Central<br />
