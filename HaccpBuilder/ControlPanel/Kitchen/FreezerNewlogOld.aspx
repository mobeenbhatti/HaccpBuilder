<%@ Page Language="C#" MasterPageFile="~/ControlPanel/Kitchen/MasterPage2.master" AutoEventWireup="true" Inherits="ControlPanel_Kitchen_FreezerNewlog"
    Title="HACCP Builder | Freezer Log" Codebehind="FreezerNewlogOld.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PlaceHolder" runat="Server">
    ...
    <div class="bdy_contents">
        ...
        <div class="log_heading">
            <div class="red_heading">
                { List of Freezer Log Entries }</div>
        </div>
                            ...
                            <tr>
                                ...
                                <asp:RegularExpressionValidator ID="REV_txtLocation" runat="server" ControlToValidate="txtLocation"
                                    ...
                                    <asp:DropDownList ID="ddlFreezerNewLogDevice" Width="200px" DataSourceID="odsFreezerNewLogDevice"
                                        CssClass="log_textbox" DataTextField="Name" DataValueField="Id" AppendDataBoundItems="false" data-editableCombobox="true"
                                        runat="server">
