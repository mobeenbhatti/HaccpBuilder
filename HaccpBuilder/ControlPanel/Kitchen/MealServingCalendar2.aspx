...
//  }
    ...
    <%--<center>--%>
        ...
        <div class="GirdDiv">
            ...
            <%--<asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>  --%> 
                    <div class="GirdDiv">
                    <%--<asp:GridView ID="grdMealCalendar" runat="server" DataSourceID="ObjectDataSource1" SkinID="gridviewSkin" 
                            AutoGenerateColumns="false" onrowcommand="grdMealCalendar_RowCommand">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Breakfast" HeaderStyle-CssClass="gridheaderline">
                                <ItemTemplate>
                                    <asp:CheckBox ID="chkBreakFast" runat="server" 
                                        ...
                                        oncheckedchanged="chkBreakFast_CheckedChanged" AutoPostBack="true" />
                                </ItemTemplate>
                                <HeaderStyle CssClass="gridheaderline"></HeaderStyle>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Lunch" HeaderStyle-CssClass="gridheaderline">
                                <ItemTemplate>
                                    <asp:CheckBox ID="chkLunch" runat="server" 
                                        Checked='<%# Eval("Lunch").ToString() == "1"? true:false %>' AutoPostBack="true"
 ...
 <ItemTemplate>
     <tr >
        ...
        <td align="center">
        <%--<asp:HyperLink ID="hlBreakFast" Text="View" NavigateUrl='<%#"~/ControlPanel/Kitchen/MealServingByDate1.aspx?EventId=1&MealCalendarId="+ DataBinder.Eval(Container.DataItem, "Id")  %>'
        ...
        <td align="center">
        <%--<asp:HyperLink ID="hlLunch" Text="View" NavigateUrl='<%#"~/ControlPanel/Kitchen/MealServingByDate1.aspx?EventId=2&MealCalendarId="+ DataBinder.Eval(Container.DataItem, "Id")  %>'
         runat="server" ></asp:HyperLink>--%>
        <asp:LinkButton ID="lkbLunch" runat="server" Text="Select" CommandName="Lunch" />
        </td>
        <td>
