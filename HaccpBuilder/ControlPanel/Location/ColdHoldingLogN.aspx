            ...
            <div class="panel-body">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <asp:Label ID="Lbl_QCLMaxtempValue" Text="NA" CssClass="form-control" runat="server"></asp:Label>
                    </div>
                </div>
                <div class="col-sm-4">
                    <label for="freezer-device">QCL Minimum Temp:</label>
                    <asp:Label ID="Lbl_QCLMintempValue" CssClass="form-control" Text="NA" runat="server"></asp:Label>
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <label for="ddlIngredient">
                            <asp:RadioButton ID="rdbIngredient" Checked="true" Text="Inputs" onClick="SetFoodItem(2)" CssClass="form-control"
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="rfvMenuItem" Enabled="false" runat="server" Display="None"
                            ErrorMessage="Please Select Output" ControlToValidate="ddlMenuItem" CssClass="form-control"
