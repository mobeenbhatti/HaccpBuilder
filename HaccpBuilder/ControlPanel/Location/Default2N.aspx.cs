...
{
    public partial class Default2N : System.Web.UI.Page
    {
            ...
            if (Request.QueryString["task"] != null)
            {
                ...
                switch (strTask.ToUpper().Trim())
                {
                    case "CLEANING AND SANITIZATION LOG":
                        ...
                        {
                            Response.Redirect("~/ControlPanel/Location/CleaningLogN.aspx?date=" + Request.QueryString["date"].ToString());
                        }
                        else
                        {
                    ...
                    case "END POINT TEMPERATURE LOG":
                        ...
                        {
                            Response.Redirect("~/ControlPanel/Location/TemperatureLogN.aspx");
                        }
                        break;
                    case "HOT HOLDING LOG":
                        if (Request.QueryString["date"] != null)
                        {
                            Response.Redirect("~/ControlPanel/Location/HotHoldingLogN.aspx?date=" + Request.QueryString["date"].ToString());
                        }
                        else
                        {
                            Response.Redirect("~/ControlPanel/Location/HotHoldingLogN.aspx");
                        }
                        break;
                    case "COLD HOLDING LOG":
                        if (Request.QueryString["date"] != null)
                        {
                            Response.Redirect("~/ControlPanel/Location/ColdHoldingLogN.aspx?date=" + Request.QueryString["date"].ToString());
                        }
                        else
                        {
                            Response.Redirect("~/ControlPanel/Location/ColdHoldingLogN.aspx");
                        }
                        break;
                    case "FREEZER LOG":
                        if (Request.QueryString["date"] != null)
                    ...
                    case "MAINTENANCE LOG":
                        if (Request.QueryString["date"] != null)
                        {
                            Response.Redirect("~/ControlPanel/Location/MaintenanceLogN.aspx?date=" + Request.QueryString["date"].ToString());
                        }
                        else
                        {
                            Response.Redirect("~/ControlPanel/Location/MaintenanceLogN.aspx");
                        }
                        break;
                    case "PH LOG":
                        if (Request.QueryString["date"] != null)
                        {
                            Response.Redirect("~/ControlPanel/Location/PhLogN.aspx?date=" + Request.QueryString["date"].ToString());
                        }
                        else
                        {
                            Response.Redirect("~/ControlPanel/Location/PhLogN.aspx");
                        }
                        break;
                    case "PEST CONTROL LOG":
                        if (Request.QueryString["date"] != null)
                        {
                            Response.Redirect("~/ControlPanel/Location/PestLogN.aspx?date=" + Request.QueryString["date"].ToString());
                        }
                        else
                        {
                            Response.Redirect("~/ControlPanel/Location/PestLogN.aspx");
                        }
                        break;
                    case "SHIPPING LOG":
                        if (Request.QueryString["date"] != null)
                        {
                            Response.Redirect("~/ControlPanel/Location/ShippingLogN.aspx?date=" + Request.QueryString["date"].ToString());
                        }
                        else
                        {
                            Response.Redirect("~/ControlPanel/Location/ShippingLogN.aspx");
                        }
                        break;
                    case "RECEIVING LOG":
                        if (Request.QueryString["date"] != null)
                        {
                            Response.Redirect("~/ControlPanel/Location/RecievingLogN.aspx?date=" + Request.QueryString["date"].ToString());
                        }
                        else
                        {
                            Response.Redirect("~/ControlPanel/Location/RecievingLogN.aspx");
                        }
                        break;
                    case "COOLING TEMPERATURE LOG":
                        if (Request.QueryString["date"] != null)
                        {
                            Response.Redirect("~/ControlPanel/Location/FreezerLogN.aspx?date=" + Request.QueryString["date"].ToString());
                        }
                        else
                        {
                            Response.Redirect("~/ControlPanel/Location/FreezerLogN.aspx");
                        }
                        break;
                    case "REFRIGERATION LOG":
                        if (Request.QueryString["date"] != null)
                        {
                            Response.Redirect("~/ControlPanel/Location/RefrigerationLogN.aspx?date=" + Request.QueryString["date"].ToString());
                        }
                        else
                        {
                            Response.Redirect("~/ControlPanel/Location/RefrigerationLogN.aspx");
                        }
                        break;
                    case "FOOD SAFETY CHECK LIST":
                        if (Request.QueryString["date"] != null)
                        {
                            ...
                            {
                                Response.Redirect("~/ControlPanel/Location/FoodSafetyChecklistN.aspx?week=" + week.ToString() + "&year=" + year.ToString() + "&Date=" + Request.QueryString["date"].ToString());
                        ...
                        else
                        {
                            ...
                            Response.Redirect("~/ControlPanel/Location/FoodSafetyChecklistN.aspx?week=" + week.ToString() + "&Date=" + DateTime.Today.ToShortDateString());
                        }
                        break;
                    ...
                    case "THERMOMETER CALIBRATION":
                        if (Request.QueryString["date"] != null)
                        {
                            Response.Redirect("~/ControlPanel/Location/ThermoCalibrationLogN.aspx?date=" + Request.QueryString["date"].ToString());
                        }
                        else
                        {
                            Response.Redirect("~/ControlPanel/Location/ThermoCalibrationLogN.aspx");
                        }
                        break;
                    case "VALIDATION CHECKLIST":
                        if (Request.QueryString["date"] != null)
                        {
                            Response.Redirect("~/ControlPanel/Location/ValidationChecklistN.aspx?date=" + Request.QueryString["date"].ToString());
                        }
                        else
                        {
                            Response.Redirect("~/ControlPanel/Location/ValidationChecklistN.aspx?date=" + DateTime.Today.ToShortDateString());
                        }
                        break;
