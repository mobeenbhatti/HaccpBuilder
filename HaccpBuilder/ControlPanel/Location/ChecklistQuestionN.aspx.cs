...
{
    public partial class ChecklistQuestionN : System.Web.UI.Page
    {
        ...
        {
            SaveResponses();
            Response.Redirect("~/ControlPanel/Location/ChecklistQuestionReviewN.aspx?HistoryId=" + hfHistoryId.Value);
        }
