...
namespace HaccpBuilder.ControlPanel.Location
{
    public partial class FreezerLogN : System.Web.UI.Page
    {
        ...
        protected void ValidateTime2(object source, ServerValidateEventArgs args)
        {
            ...
            {
                if (tempratureTime2.Text != "" && tempratureTime1.Text != "")
                {
        ...
        protected void ValidateTemp3(object source, ServerValidateEventArgs args)
        {
            ...
            {
                nResult = 0;
                if (tempratureTime3.Text != "" && tempratureTime2.Text != "")
                {
        ...
        private void InsertData()
        {
            ...
            freezerLog.MealDate = DateTime.Parse(cldEntryDate.Text);
            if (rdbIngredient.Checked == true)
            {
            ...
            freezerLog.VerifiedDate = DateTime.Parse(cldVerifiedDate.Text);
        ...
        private void SetTime(int nPeriod, DateTime dtTime)
        {
            if (nPeriod == 1)
            {
                tempratureTime1.Text = dtTime.ToString();
            
            }
            else if (nPeriod == 2)
            {
                tempratureTime2.Text = dtTime.ToString();
         
            }
            else if (nPeriod == 3)
            {
                tempratureTime3.Text = dtTime.ToString();
