<%@ Page Title="" Language="C#" MasterPageFile="~/ControlPanel/Location/LocationLayout.Master" AutoEventWireup="true" CodeBehind="FreezerNewLogN.aspx.cs" Inherits="HaccpBuilder.ControlPanel.Location.FreezerNewLogN" %>
                    ...
                    <asp:GridView ID="grdHotHolding" HeaderStyle-CssClass="col" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-hover table-responsive table-bordered"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Service Date">
                                <ItemTemplate>
                                    <asp:HyperLink ID="hlEntryDate" runat="server" NavigateUrl='<%#"~/ControlPanel/Location/FreezerNewLogN.aspx?Id=" + DataBinder.Eval(Container.DataItem, "Id") %>'
