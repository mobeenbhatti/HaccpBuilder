...
namespace HaccpBuilder.ControlPanel.Location
{
    public partial class ThermoCalibrationLogN : System.Web.UI.Page
    {
        ...
        {
            ThermoCalibrationLog thermoCalibrationLog = new ThermoCalibrationLog();
            thermoCalibrationLog.MealDate = DateTime.Parse(cldMealDate.Text);
            int nWeekNumber = GetWeekNumber(DateTime.Parse(cldMealDate.Text));
            if (txtTemperature.Text != "")
            {
            ...
            thermoCalibrationLog.VerifiedDate = DateTime.Parse(cldVerifiedDate.Text);
