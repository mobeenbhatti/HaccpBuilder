<%@ Page Title="" Language="C#" MasterPageFile="~/ControlPanel/Location/LocationLayout.Master" AutoEventWireup="true" CodeBehind="RefrigerationLogN.aspx.cs" Inherits="HaccpBuilder.ControlPanel.Location.RefrigerationLogN" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="pageTitle" runat="server">
    <h1>Refrigration Log</h1>
</asp:Content>
    ...
    <div class="row mt30">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <i class="fa fa-tasks"></i>Refrigration Log
            </div>
            <div class="panel-body tasks">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <label for="freezer-device">Unit/Device Selection:</label>
                            <asp:DropDownList ID="ddlRefrigerationDevice" DataSourceID="odsRefrigerationDevice" data-editableCombobox="true"
                                CssClass="form-control" DataTextField="Name" DataValueField="Id" Font-Size="Small" AppendDataBoundItems="false"
                                runat="server">
                            ...
                            <asp:RequiredFieldValidator ID="rfvIngredient" runat="server" Display="None" ErrorMessage="Please Select Refrigeration Device"
                                ControlToValidate="ddlRefrigerationDevice" CssClass="form-control" Font-Names="Verdana"
                        ...
                        <asp:GridView ID="grdHotHolding" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-hover table-responsive table-bordered"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Service Date" ItemStyle-HorizontalAlign="Center" HeaderStyle-Font-Size="Small" ItemStyle-Font-Size="Small">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="hlEntryDate" runat="server" NavigateUrl='<%#"~/ControlPanel/Location/RefrigerationLogN.aspx?Id=" + DataBinder.Eval(Container.DataItem, "Id") %>'
