...
{
    public partial class ShippingLogN : System.Web.UI.Page
    {
        ...
        {
            ShippingLog shippingLog = new ShippingLog();
            shippingLog.MealDate = DateTime.Parse(cldMealDate.Text);
            if (txtTemperature.Text != "")
            {
            ...
            shippingLog.VerifiedDate = DateTime.Parse(cldVerifiedDate.Text);
