...
public partial class ControlPanel_Mobile_PestLog : System.Web.UI.Page
{
...
//select f.value
            ...
            cldEntryDate.SelectedDate = log.p.EntryDate;
        ...
        else
        {
            if (Request.QueryString["date"] != null)
            {
                ...
                if (log != null)
                {
                    cldEntryDate.SelectedDate = log.EntryDate;
                    if (log.IsClean == true)
                        rdbCleanYes.Checked = true;
                    else
                        rdbCleanNo.Checked = true;
                    ...
                    cldVerifiedDate.SelectedDate = log.VerifiedDate;
