<%@ Control Language="C#" AutoEventWireup="true" Inherits="Controls_FreeTrialCatertrax" Codebehind="FreeTrialCatertrax.ascx.cs" %>
	...
	<tr>
		<td style="width: 200px;">
			...
			<%--<asp:RegularExpressionValidator ID="revNumberOfKitchens" runat="server" ControlToValidate="txtKitchenName"
				Display="Dynamic" EnableClientScript="true" ErrorMessage="Please enter a name without special characters (@#$*&)."
	...
	<%--<tr>
		<td>
			...
			<asp:RequiredFieldValidator ID="rfvNumberOfKitchens" runat="server" ControlToValidate="txtNumberOfKitchens"
				Display="Dynamic" EnableClientScript="true" ErrorMessage="Please enter number of kitchens in Kitchen.<br />"></asp:RequiredFieldValidator>
	...
	<tr>
		<td style="width: 200px;">
            ...
            <asp:RequiredFieldValidator ID="rfvState2" runat="server" ControlToValidate="txtState" Enabled="false"
				 EnableClientScript="true" ErrorMessage="Please enter a state/province.<br />"></asp:RequiredFieldValidator>
			State:&nbsp;</td>
		<td>
