<%@ Page Language="C#" MasterPageFile="~/ControlPanel/MasterPage2.master" AutoEventWireup="true" Inherits="ControlPanel_FreezerLog" Title="HACCP Builder | Cooling Temperature Log" Codebehind="FreezerLogold.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PlaceHolder" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function SetFoodItem(status) {
            var vldMenuItem = document.getElementById('ctl00_PlaceHolder_rfvMenuItem');
            var vldIngrdient = document.getElementById('ctl00_PlaceHolder_rfvIngredient');
            var ddlMenuItem = document.getElementById('ctl00_PlaceHolder_ddlMenuItem');
            var ddlIngredient = document.getElementById('ctl00_PlaceHolder_ddlIngredient');
            if (status == 1) {
        ...
        function CheckTemperature1(sender, args) {
            // var vldCorrectiveAction = document.getElementById('ctl00_PlaceHolder_rfvCorrectiveAction');
            // var vldIngrdient= document.getElementById('ctl00_PlaceHolder_rfvIngredient');
            var txtTemp1 = document.getElementById('ctl00_PlaceHolder_txtTemp1');

            var hfTempLow = document.getElementById('ctl00_PlaceHolder_hfTempLow');
            var hfTempHigh = document.getElementById('ctl00_PlaceHolder_hfTempHigh');
            var txtCorrectiveAction = document.getElementById('ctl00_PlaceHolder_txtCorrectiveAction');
        ...
        function CheckTemperature2(sender, args) {
            ...
            var txtTemp2 = document.getElementById('ctl00_PlaceHolder_txtTemp2');
            var hfTempLow = document.getElementById('ctl00_PlaceHolder_hfTempLow');
            var hfTempHigh = document.getElementById('ctl00_PlaceHolder_hfTempHigh');
            var txtCorrectiveAction = document.getElementById('ctl00_PlaceHolder_txtCorrectiveAction');
        ...
        function CheckTemperature3(sender, args) {
            ...
            var txtTemp3 = document.getElementById('ctl00_PlaceHolder_txtTemp3');
            var hfTempLow = document.getElementById('ctl00_PlaceHolder_hfTempLow');
            var hfTempHigh = document.getElementById('ctl00_PlaceHolder_hfTempHigh');
            var txtCorrectiveAction = document.getElementById('ctl00_PlaceHolder_txtCorrectiveAction');
        ...
        function CheckTemperature4(sender, args) {
            ...
            var txtTemp4 = document.getElementById('ctl00_PlaceHolder_txtTemp4');
            var hfTempLow = document.getElementById('ctl00_PlaceHolder_hfTempLow');
            var hfTempHigh = document.getElementById('ctl00_PlaceHolder_hfTempHigh');
            var txtCorrectiveAction = document.getElementById('ctl00_PlaceHolder_txtCorrectiveAction');
        ...
        function CheckTemperature5(sender, args) {
            ...
            var txtTemp5 = document.getElementById('ctl00_PlaceHolder_txtTemp5');
            var hfTempLow = document.getElementById('ctl00_PlaceHolder_hfTempLow');
            var hfTempHigh = document.getElementById('ctl00_PlaceHolder_hfTempHigh');
            var txtCorrectiveAction = document.getElementById('ctl00_PlaceHolder_txtCorrectiveAction');
        ...
        function CheckTemperature6(sender, args) {
            ...
            var txtTemp6 = document.getElementById('ctl00_PlaceHolder_txtTemp6');
            var hfTempLow = document.getElementById('ctl00_PlaceHolder_hfTempLow');
            var hfTempHigh = document.getElementById('ctl00_PlaceHolder_hfTempHigh');
            var txtCorrectiveAction = document.getElementById('ctl00_PlaceHolder_txtCorrectiveAction');
                        ...
                        <table width="368" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td width="225">
                                   <b> <asp:Label ID="Lbl_QCLMaxtempValue" Text="NA" runat="server"></asp:Label></b>
                                </td>
                            </tr>
                            <tr>
                                <td width="138" align="right">
                                ...
                                <td width="225">
                                    <b><asp:Label ID="Lbl_QCLMintempValue"  Text="NA" runat="server"></asp:Label></b>
                                </td>
                            </tr>
                            <tr>
                                <td width="138" align="right">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:DropDownList ID="ddlIngredient" Width="200px" DataSourceID="odsIngredient" CssClass="log_textbox"
                                        Enabled="false" DataTextField="Name" DataValueField="IngredientId" AppendDataBoundItems="true"
                                        runat="server">
                                        <asp:ListItem>Select Ingredient</asp:ListItem>
                                    </asp:DropDownList>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:RadioButton ID="rdbMenuItem" Text="Product/Menu Item" onClick="SetFoodItem(1)"
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:CustomValidator ID="CustomValidator2" ControlToValidate="txtTemp1" OnServerValidate="ValidateTemp1" runat="server"
                                        ErrorMessage="Please fill Corrective Action field for Temp1" Display="None"></asp:CustomValidator>
                                    <asp:RegularExpressionValidator ID="rglValidateTemp1" runat="server" ControlToValidate="txtTemp1"
                                        Display="None" ErrorMessage="The value in field Internal Temp1 is not valid.Please enter the temperature value between 9999 to -9999"
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:CustomValidator ID="CustomValidator1" ControlToValidate="txtTemp2" OnServerValidate="ValidateTemp2" runat="server"
                                        ErrorMessage="Please fill Corrective Action field for Temp2" Display="None"></asp:CustomValidator>
                                    <asp:RegularExpressionValidator ID="rglValidateTemp2" runat="server" ControlToValidate="txtTemp2"
                                        Display="None" ErrorMessage="The value in field Internal Temp 2 is not valid.Please enter the temperature value between 9999 to -9999"
                                        Font-Names="Verdana" Font-Size="10px" ValidationExpression="^[\-+]?[0-9]{1,4}(\.[0-9]{1,2})?$"></asp:RegularExpressionValidator>
                                </td>
                            </tr>
                              <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:CustomValidator ID="CustomValidator3" ControlToValidate="txtTemp3" OnServerValidate="ValidateTemp3" runat="server"
                                        ErrorMessage="Please fill Corrective Action field for Temp3" Display="None"></asp:CustomValidator>
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtTemp3"
                                        Display="None" ErrorMessage="The value in field Internal Temp 3 is not valid.Please enter the temperature value between 9999 to -9999"
                                        Font-Names="Verdana" Font-Size="10px" ValidationExpression="^[\-+]?[0-9]{1,4}(\.[0-9]{1,2})?$"></asp:RegularExpressionValidator>
                                </td>
                            </tr>
                           ...
                           <%-- <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:ImageButton ID="cmdDelete" Visible="false" OnClick="cmdDelete_Click" runat="server"
