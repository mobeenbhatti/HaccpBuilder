<%@ Control Language="C#" AutoEventWireup="true" Inherits="Controls_Contact" Codebehind="Contact.ascx.cs" %>
	...
	<tr>
		<td style="width: 200px;">
			<asp:RequiredFieldValidator ID="rfvDistrictName" runat="server" ControlToValidate="txtDistrictName"
				Display="Dynamic" EnableClientScript="true" ErrorMessage="Please enter your district name.<br />"></asp:RequiredFieldValidator>
			District Name:&nbsp;</td>
		<td>
			<asp:TextBox ID="txtDistrictName" runat="server" Columns="50" CssClass="textField"
	...
	<tr>
		<td style="width: 200px;">
			<asp:RequiredFieldValidator ID="rfvState" runat="server" ControlToValidate="ddlStateProvince"
				Display="Dynamic" EnableClientScript="true" ErrorMessage="Please select a state.<br />"></asp:RequiredFieldValidator>
			State:&nbsp;</td>
		<td>
			...
			</asp:DropDownList><asp:ObjectDataSource ID="odsStateProvince" runat="server" OldValuesParameterFormatString="original_{0}"
	...
	<tr>
		<td style="width: 200px;">
			<asp:RequiredFieldValidator ID="rfvCountry" runat="server" ControlToValidate="ddlCountryRegion"
				Display="Dynamic" EnableClientScript="true" ErrorMessage="Please select a country.<br />"></asp:RequiredFieldValidator>
			Country:&nbsp;</td>
		<td>
	...
	<tr>
		<td>
			...
			<asp:RegularExpressionValidator ID="revEmail" runat="server" ControlToValidate="txtEmail"
				Display="Dynamic" EnableClientScript="true" ErrorMessage="Please enter a valid email.<br />"
	...
	<tr>
		<td style="width: 200px;">
			<asp:RequiredFieldValidator ID="rfvPhone" runat="server" ControlToValidate="txtPhone"
				Display="Dynamic" EnableClientScript="true" ErrorMessage="Please enter your phone number.<br />"></asp:RequiredFieldValidator>
			Phone Number:&nbsp;</td>
		<td>
