...
public partial class Controls_MultiCheckDropdown : System.Web.UI.UserControl
{
    ...
    /// Add Items to the CheckBoxList.
    /// </summary>
    /// <param name="array">DataSet to be added to the CheckBoxList</param>
    public void AddItems(DataSet dsItems)
    {
        ClearAll();
        int i = 0;
