<%@ Control Language="C#" AutoEventWireup="true" Inherits="Controls_FreeTrialKitchen" Codebehind="FreeTrialKitchen.ascx.cs" %>
...
<table border="0" cellpadding="0" cellspacing="0" class="zebra" style="text-align:left">
    ...
    <tr>
		...
		<td>
            ...
            <asp:DropDownList ID="ddlCountryRegion" runat="server" Width="200px" DataSourceID="sqlDsCountry" DataTextField="Name" DataValueField ="CountryRegionCode" AutoPostBack="true"
