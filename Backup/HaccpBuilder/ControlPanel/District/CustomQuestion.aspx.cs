...
public partial class ControlPanel_District_CustomQuestion : System.Web.UI.Page
{
    ...
    protected void cmdContinue_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("~/ControlPanel/District/QuestionsReview.aspx?Review=1&GroupId=" + ddlChecklistGroup.SelectedValue);
        }
            ...
            if (hfQuestionId != null || chkCustom != null)
            {
                if (chkDefault.Text == hfQuestionId.Value)
                {
                    if (chkCustom.Checked == true)
                    {
                        ...
                        deleteQuestion.FoodSafetyQuestion = question;
    ...
    protected void chkCustom_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (chkCustom.Checked == true)
        {
            ...
            strGroupId = ddlChecklistGroup.SelectedValue;
            strSection = lblIteration.Text;
            Response.Redirect("~/ControlPanel/District/EditQuestion.aspx?QuestionId=" + strQuestionId + "&GroupId=" + strGroupId + "&Mode=1" + "&Section=" + strSection);
        }
    }
    ...
    protected void grdQuestion_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            string strGroupId, strQuestionId, strSection;
            strQuestionId = e.CommandName;
            strGroupId = ddlChecklistGroup.SelectedValue;
            strSection = lblIteration.Text;
            Response.Redirect("~/ControlPanel/District/EditQuestion.aspx?QuestionId=" + strQuestionId + "&GroupId=" + strGroupId + "&Mode=3" + "&Section=" + strSection);
        }
    }
