<%@ Page Title="" Language="C#" MasterPageFile="CorporateMaster.master"
    AutoEventWireup="true" Inherits="ControlPanel_District_ColdHoldingCustom" Codebehind="ColdHoldingCustom.aspx.cs" %>
...
td {line-height: 2.0em;}
    ...
    <script language="javascript" type="text/javascript">
        ...
        function CheckLimits() {
            ...
            if (txtQclLow.parseFloat(value) < txtCclLow.parseFloat(value)) {
                alert('Low 1');
                lblMsg.parseFloat(value) = 'QCL low temp value should be within range of CCL';
                return false;
            }
            if (txtQclLow.parseFloat(value) > txtCclHigh.parseFloat(value)) {
                alert('Low 2');
                lblMsg.parseFloat(value) += '<br/>QCL low temp value should be within range of CCL';
                return false;
            }
            if (txtQclHigh.parseFloat(value) < txtCclLow.parseFloat(value)) {
                alert('High 1');
                lblMsg.parseFloat(value) += '<br/>QCL high temp value should be within range of CCL';
                return false;
            }
            if (txtQclHigh.parseFloat(value) > txtCclHigh.parseFloat(value)) {
                alert('High 2');
                lblMsg.parseFloat(value) += '<br/>QCL high temp value should be within range of CCL';
                return false;
            }
...
<cc1:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
        ...
        <ContentTemplate>
         <div class="container">
            ...
            <div class="popUpStyleNew" id="divPopUp" style="display: none;">
                ...
                <asp:RegularExpressionValidator ID="revCorrectiveAction" ValidationGroup="CA" runat="server" ControlToValidate="txtActionName"
                    ErrorMessage="The value in field Action Name is not valid." Font-Names="Verdana"
   ...
   <asp:ValidationSummary ID="vldSummary" CssClass="msg-error" DisplayMode="List" runat="server" ShowSummary="true" />
	...
	<table  border="0" cellspacing="0" cellpadding="0" > 
                ...
                <tr>
                <td colspan="3">
                    <asp:Panel ID="pnlCriticalLimits" runat="server">
                                <table width="540" border="0" id="tblCriticalLimits" runat="server">
                                 <tr>
                                        <td colspan="5">
                                    ...
                                    <tr>
                                        ...
                                        <td style="display:none;" align="center" >
                                            Minimum Time Requirement(Minutes)
                                        </td>
                                        <td style="display:none;" align="center" >
                                            Maximum Time Requirement(Minutes)
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        Display="None" ErrorMessage="The value in field 'CCL(Maximum Temperature)' is not valid.Please enter the temperature value between 9999.99 to -9999.99"
                                        Font-Names="Verdana" Font-Size="10px" ValidationExpression="^[\-+]?[0-9]{1,4}(\.[0-9]{1,2})?$"></asp:RegularExpressionValidator>
                                        </td>
                                        <td style="display:none;" align="center">
                       ...
                       <asp:RegularExpressionValidator ID="REV_txtCclMax" runat="server" ControlToValidate="txtCclMax"
                                    ...
                                    <tr>
                                        ...
                                        Display="None" ErrorMessage="The value in field 'QCL(Minimum Temperature)' is not valid.Please enter the temperature value between 9999.99 to -9999.99"
                                        Font-Names="Verdana" Font-Size="10px" ValidationExpression="^[\-+]?[0-9]{1,4}(\.[0-9]{1,2})?$"></asp:RegularExpressionValidator>
                                        </td>
                                        <td style="display:none;" align="center">
                                 ...
                                 <table id="tblTemperatureLog" runat="server" visible="false">
                                   <!-- SECOND TIME VALUES--> 
                                   <tr >
                                        <td>
                                      <table>                     
                                    ...
                                    <tr>
                                        ...
                                        Display="None" ErrorMessage="The value in field 'CCL 1(Maximum Temperature)' is not valid.Please enter the temperature value between 9999.99 to -9999.99"
                                        Font-Names="Verdana" Font-Size="10px" ValidationExpression="^[\-+]?[0-9]{1,4}(\.[0-9]{1,2})?$"></asp:RegularExpressionValidator>
                                        </td> 
                                        <td>&nbsp;</td> 
                                        <td>&nbsp;</td>                                        
                                    ...
                                    <tr>
                                        ...
                                        Display="None" ErrorMessage="The value in field 'QCL 1(Minimum Temperature)' is not valid.Please enter the temperature value between 9999.99 to -9999.99"
                                        Font-Names="Verdana" Font-Size="10px" ValidationExpression="^[\-+]?[0-9]{1,4}(\.[0-9]{1,2})?$"></asp:RegularExpressionValidator>
                                        </td>
                                        <td>&nbsp;</td> 
                                        <td>&nbsp;</td>                                         
                                   ...
                                   <!-- Validation for First Set of Values -->
                                    ...
                                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="txtCclHigh"
                                        ...
                                        ErrorMessage="The Value in field CCL High Temp field should be Greater than or equal to CCL Low Temp field"></asp:CompareValidator>
