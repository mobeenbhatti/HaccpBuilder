<%@ Page Language="C#" MasterPageFile="~/ControlPanel/Location/LocationMaster.master" AutoEventWireup="true" Inherits="ControlPanel_Location_RecievingLog" Title="HACCP Builder | Receiving Log" Codebehind="RecievingLog.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PlaceHolder" runat="Server">
    ...
    <p> Directions: Use this Log for deliveries or receiving foods. Record any temperatures
         ...
         <asp:GridView ID="grdHotHolding" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-hover"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Service Date" ItemStyle-HorizontalAlign="Center" HeaderStyle-Font-Size="Small" ItemStyle-Font-Size="Small" >
                        <ItemTemplate>
                            <asp:HyperLink ID="hlEntryDate" runat="server" NavigateUrl='<%#"~/ControlPanel/Location/RecievingLog.aspx?Id=" + DataBinder.Eval(Container.DataItem, "Id") %>'
