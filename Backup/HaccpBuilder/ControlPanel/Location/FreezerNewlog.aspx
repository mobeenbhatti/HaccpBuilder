<%@ Page Language="C#" MasterPageFile="~/ControlPanel/Location/LocationMaster.master" AutoEventWireup="true" Inherits="ControlPanel_Location_FreezerNewlog"
    Title="HACCP Builder | Freezer Log" Codebehind="FreezerNewlog.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PlaceHolder" runat="Server">
    ...
    <p>Directions:A designated foodservice employee will record the location or description
        ...
        <div class=".form-horizontal">  
            ...
            <div class="control-group">
                ...
                <asp:DropDownList ID="ddlFreezerNewLogDevice" Width="200px" DataSourceID="odsFreezerNewLogDevice"
                                        CssClass="log_textbox" DataTextField="Name" DataValueField="Id" Font-Size="Small" AppendDataBoundItems="false" data-editableCombobox="true"
                                        runat="server">
