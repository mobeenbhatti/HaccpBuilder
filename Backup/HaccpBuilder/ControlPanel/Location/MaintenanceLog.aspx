<%@ Page Language="C#" MasterPageFile="~/ControlPanel/Location/LocationMaster.master" AutoEventWireup="true" Inherits="ControlPanel_Location_MaintenanceLog" Title="HACCP Builder | Maintenance Log" Codebehind="MaintenanceLog.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PlaceHolder" runat="Server">
    ...
    <p>Directions: Record item name, time, the Maintenance levels, and any corrective action taken on this form. 
    ...
    <div class="col-lg-6 col-md-6 portfolio-ite">
        <div class=".form-horizontal">  
            ...
            <div class="control-group">
                ...
                <div class="controls">
                <asp:DropDownList ID="ddlInventory" DataSourceID="ObjectDataSource2" Enabled="true" CssClass="log_textbox"
    ...
    <div class="col-lg-6 col-md-6 col-xs-12 portfolio-ite">
         <asp:GridView ID="grdMaintenance" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-hover"
                DataSourceID="ObjectDataSource1" AllowPaging="True">
                <Columns>
                    <asp:BoundField DataField="Id" HeaderText="Entry ID"  />                    
                    <asp:TemplateField HeaderText="Service Date" >
                        <ItemTemplate>
                            <asp:HyperLink ID="hlEntryDate" runat="server" NavigateUrl='<%#"~/ControlPanel/Location/MaintenanceLog.aspx?Id=" + DataBinder.Eval(Container.DataItem, "Id") %>'
