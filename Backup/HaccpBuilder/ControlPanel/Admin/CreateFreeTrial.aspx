<%@ Page Language="C#" MasterPageFile="~/ControlPanel/AdminMaster.master" AutoEventWireup="true" Inherits="ControlPanel_Admin_CreateFreeTrial"
    ...
    <div>
        ...
        <div class="ContentLeft">
           ...
           <asp:RegularExpressionValidator ID="REV_txtManagerName" runat="server" ControlToValidate="txtManagerName"
                        Display="None" EnableClientScript="true" ErrorMessage="The value in field 'Kitchen Manager Name' is not valid."
     ...
     <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtCity"
            ...
            <div class="SearchDiv1">
                <div class="DistrictSearchCol1">
                    Number of Menu Items</div>
                <div class="DistrictSearchCol2">
                    <asp:TextBox ID="txtMenu" runat="server" MaxLength="3" Width="200px" CssClass="TextBox1"></asp:TextBox>
                </div>
                <asp:RequiredFieldValidator ID="rfvMenu" runat="server" Display="None" ErrorMessage="The value in field Menu Items is required."
                    ControlToValidate="txtMenu" Font-Names="Verdana" Font-Size="10px"></asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtMenu"
                    Font-Names="Verdana" Font-Size="10px" Display="None" EnableClientScript="true"
                    ErrorMessage="Please enter a valid integer in Menu Item field." ValidationExpression="(\d)+"></asp:RegularExpressionValidator>
            </div>
            <div class="SearchDiv1">
                <div class="DistrictSearchCol1">
                    Number of Ingredients</div>
                <div class="DistrictSearchCol2">
                    <asp:TextBox ID="txtIngredient" MaxLength="3" runat="server" Width="200px" CssClass="TextBox1"></asp:TextBox>
                </div>
                <asp:RequiredFieldValidator ID="rfvIngredient" runat="server" Display="None" ErrorMessage="The value in field Ingredient is required."
                    ControlToValidate="txtIngredient" Font-Names="Verdana" Font-Size="10px"></asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtIngredient"
                    Font-Names="Verdana" Font-Size="10px" Display="None" EnableClientScript="true"
                    ErrorMessage="Please enter a valid integer in Ingredient field." ValidationExpression="(\d)+"></asp:RegularExpressionValidator>
            </div>
            <div class="SearchDiv1">
                <div class="DistrictSearchCol1">
                    Number of Vendors</div>
                <div class="DistrictSearchCol2">
                    <asp:TextBox ID="txtVendors" MaxLength="3" runat="server" Width="200px" CssClass="TextBox1"></asp:TextBox>
                </div>
                <asp:RequiredFieldValidator ID="rfvVendors" runat="server" Display="None" ErrorMessage="The value in field Vendors is required."
                    ControlToValidate="txtVendors" Font-Names="Verdana" Font-Size="10px"></asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtVendors"
                    Font-Names="Verdana" Font-Size="10px" Display="None" EnableClientScript="true"
                    ErrorMessage="Please enter a valid integer in Vendor field." ValidationExpression="(\d)+"></asp:RegularExpressionValidator>
            </div>
            <div class="Clearer">
            </div>
