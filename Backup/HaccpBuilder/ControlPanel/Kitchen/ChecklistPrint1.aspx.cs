...
public partial class ControlPanel_Kitchen_ChecklistPrint : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (IsPostBack != true)
        {
            if (Request.QueryString["Week"] != null)
            {
                ...
                IDataReader dr = getHistory.GetHistoryByWeek((int)Session["KitchenId"], int.Parse(Request.QueryString["Week"]));
                if (dr.Read())
                {
