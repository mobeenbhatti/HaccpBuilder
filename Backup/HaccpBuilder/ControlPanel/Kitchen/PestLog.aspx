<%@ Page Title="" Language="C#" MasterPageFile="~/ControlPanel/Kitchen/Facility.Master" AutoEventWireup="true" CodeBehind="PestLog.aspx.cs" Inherits="HaccpBuilder.ControlPanel.Kitchen.PestLogNew" %>
...
<div class="container"><!----CONTAINER-START----->
  ...
  <div class="clear"></div>
  <h2>Pest Control Station/Item:</h2>
  <div class="form3">
    <div class="left">      
      <div class="input">
        <asp:DropDownList ID="ddlInventory" DataSourceID="odsPestLogKitchenInvetory" Enabled="true" CssClass="log_textbox" DataTextField="Name" DataValueField="Id" Width="200px" runat="server" data-editableCombobox="true" AppendDataBoundItems="false">
  ...
  <div class="form4 left marginright">
    <h2>Pest Control Station/Item Is Clean:</h2>
    <div class="input left">
        <asp:RadioButton ID="rdbCleanYes"  Checked="true" Text="Yes" CssClass="LogText" GroupName="CleanItem" runat="server" />
        <asp:RadioButton ID="rdbCleanNo"  Text="No" CssClass="LogText" GroupName="CleanItem" runat="server" />
  ...
  <div class="table">
    <div class="box-header">
      <h4 class="left">List of Pest Log Entries</h4>
    </div>
     <asp:GridView ID="grdPest" runat="server" AutoGenerateColumns="False" CssClass="zebra" DataSourceID="ObjectDataSource1" AllowPaging="True">
        <Columns>
