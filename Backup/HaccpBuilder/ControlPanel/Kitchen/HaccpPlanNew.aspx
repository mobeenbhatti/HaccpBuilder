<%@ Page Title="" Language="C#" MasterPageFile="~/ControlPanel/Kitchen/MasterPage2.master" AutoEventWireup="true" Inherits="ControlPanel_Kitchen_HaccpPlanNew" Codebehind="HaccpPlanNew.aspx.cs" %>
  ...
  <script type="text/javascript">  
    ...
    <div class="bdy_contents">
        ...
        <div class="buttons_bg" align="center">        
            ...
            <asp:HyperLink ID="HyperLink2" runat="server" Height="37" NavigateUrl="~/ControlPanel/Kitchen/MenuItems.aspx" ImageUrl="~/images/buttons/bt-Outputs-Menu-Items.png"></asp:HyperLink>
            <asp:HyperLink ID="HyperLink3" runat="server" Height="37" NavigateUrl="~/ControlPanel/Kitchen/Ingredients.aspx" ImageUrl="~/images/buttons/BT-Inouts-Ingredients.png"></asp:HyperLink>
                            ...
                            <tr>
                                <td align="left">
                                  ...
                                  <asp:Repeater ID="rptProcess" runat="server"  
                                   ...
                                   <asp:HyperLink ID="hlHaccpPlan3" Text="Section Three" NavigateUrl="~/ControlPanel/Kitchen/HaccpPlan3.aspx" Target="_blank" CssClass="BlueHeading" runat="server"></asp:HyperLink>                                
                                   ...
                                   <asp:HyperLink ID="hlHaccpPlan4" runat="server" NavigateUrl="~/ControlPanel/Kitchen/HaccpPlan4.aspx" Target="_blank" CssClass="BlueHeading" Text="Section Four:"></asp:HyperLink>
                                   ...
                                   <asp:HyperLink ID="hlHaccpPlan5" runat="server" NavigateUrl="~/ControlPanel/Kitchen/HaccpPlan5.aspx" Target="_blank" CssClass="BlueHeading" Text="Section Five:"></asp:HyperLink>
                                   <p>Menu Items Recipes Details</p> <br />
                                   <asp:HyperLink ID="hlHaccpPlan6" runat="server" NavigateUrl="~/ControlPanel/Kitchen/HaccpPlan6.aspx" Target="_blank" CssClass="BlueHeading" Text="Section Six:"></asp:HyperLink>
                                   <p>C-TPAT</p> <br />
                                </td>
                            </tr>
                        </table>
