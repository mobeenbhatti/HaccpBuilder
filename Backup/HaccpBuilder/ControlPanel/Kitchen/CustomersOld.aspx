<%@ Page Language="C#" MasterPageFile="~/ControlPanel/Kitchen/MasterPage2.master"  AutoEventWireup="true" Inherits="ControlPanel_Kitchen_Customers" Title="HACCP Builder | Customer" Codebehind="CustomersOld.aspx.cs" %>
...
<script language="javascript" type="text/javascript">
    ...
    <table  border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td align="right" width="138" >Upload Customers from file: </td> 
          ...
          <table width="390" border="0" cellpadding="0" cellspacing="0" class="table_form_view">
            ...
            <tr>
              <td><table width="368" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td align="right">Customer Contact Name</td>
                  <td><img src="../../images/District Images/spacer.gif" width="10" height="25" /></td>
                ...
                <tr>
                  <td align="right">Customer Phone Number:</td>
                  <td><img src="../../images/District Images/spacer.gif" width="10" height="25" /></td>
                ...
                <tr>
                  <td align="right">Does Customer have Training and Certifications in Place:</td>
                  <td><img src="../../images/District Images/spacer.gif" width="10" height="25" /></td>
                ...
                <tr><td colspan="3">&nbsp;</td></tr>
                 <tr>
                  <td align="right">If yes, please provide or describe Customer training and/or certifications:</td>
                  <td><img src="../../images/District Images/spacer.gif" width="10" height="25" /></td>
