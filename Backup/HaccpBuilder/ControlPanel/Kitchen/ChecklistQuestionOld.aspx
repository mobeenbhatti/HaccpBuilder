<%@ Page Title="" Language="C#" MasterPageFile="~/ControlPanel/Kitchen/MasterPage2.master" AutoEventWireup="true" CodeBehind="ChecklistQuestionOld.aspx.cs" Inherits="HaccpBuilder.ControlPanel.Kitchen.ChecklistQuestion" %>
<%@ Register Src="~/Controls/ContactDetail.ascx" TagPrefix="Contact" TagName="Detail" %>

<asp:Content ID="Content1" ContentPlaceHolderID="PlaceHolder" runat="server">
<script language="javascript" type="text/javascript">
    function check( vldCorrectiveAction, enable) {
...
<div class="bdy_contents">
        ...
        <div class="grey_bg_form">
            ...
            <asp:ImageButton ID="btnContinue" runat="server"  
                ImageUrl="~/images/buttons/ButtonContinueBlack.png" 
