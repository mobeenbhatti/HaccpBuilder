...
<!----CONTAINER-START----->
  ...
  <div class="form4b left marginright">
    ...
    <h4>City:</h4>
    <div class="input">
         <asp:TextBox ID="txtCity" runat="server" Enabled="false" ></asp:TextBox> </div>
    <div class="clear"></div>
    <br />
    <h4>State:</h4>
    <div class="input">
        <asp:TextBox ID="txtState" runat="server" Enabled="false" ></asp:TextBox></div>
    <div class="clear"></div>
    <br />
    <h4>TiimeZone:</h4>
    <div class="input">
        <asp:TextBox ID="txtTimeZone" runat="server" Width="200px" Enabled="false" ></asp:TextBox></div>
     <div class="clear"></div>
    <br />
    <h4>TiimeZone:</h4>
    <div class="input">
...
<!--------- End  Entry form -------------->
  <asp:UpdatePanel ID="updAlertGrid" runat="server"><ContentTemplate>
  <%--<div class="table">
