    ...
    <div>
        <center>        
            ...
            <div class="form3" style="width:300px; margin-top:150px">
                ...
                <asp:Login ID="Login1" TextBoxStyle-Width="140px" RememberMeSet="true" CheckBoxStyle-HorizontalAlign="Left" runat="server" PasswordRecoveryUrl="PasswordRecovery.aspx"
