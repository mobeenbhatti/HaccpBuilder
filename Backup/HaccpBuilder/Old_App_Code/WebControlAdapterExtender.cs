...
namespace SchoolHaccp
{
	public class WebControlAdapterExtender
	{
		...
		public WebControl AdaptedControl
		{
			get
			{
				System.Diagnostics.Debug.Assert(_adaptedControl != null, "Adapter internal error", "No control has been defined for the adapter extender");
		...
		{
			string folderPath = WebConfigurationManager.AppSettings.Get("JavaScript-Path");
			if (String.IsNullOrEmpty(folderPath))
			{
				folderPath = "~/StaticContent/Scripts";
			}
